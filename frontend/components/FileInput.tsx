...
export default function FileInput({ uploadFileHandler }: IProps) {
  return (
    <div className="bg-gray-50 relative w-full ease-linear duration-100 hover:bg-gray-200 hover:border-gray-300 focus-within:bg-gray-50 focus-within:border-gray-300 flex flex-col items-center  text-gray-400 py-6 px-12 rounded-lg border-2 border-dashed">
      <UploadIcon />
